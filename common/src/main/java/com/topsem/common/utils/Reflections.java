...
public class Reflections {
    ...
    public static List<Class> getAllClasses(Class<?> clazz) {
        ...
        getAllSuperclasses(clazz, classes);
        classes.add(clazz);
        return classes;
    }
    ...
    private static final BiMap<String, String> classNameMap = HashBiMap.create();

    static {
        classNameMap.put("byte", Byte.class.getName());
        classNameMap.put("short", Short.class.getName());
        classNameMap.put("int", Integer.class.getName());
        classNameMap.put("long", Long.class.getName());
        ...
        classNameMap.put("char", Character.class.getName());
        classNameMap.put("string", String.class.getName());
    }


    public static String getShortName(Class clazz) {
        return classNameMap.inverse().get(clazz.getName());
    }
