...
/**
 * Helper class to ease sharing code between legacy {@link org.springframework.data.web.PageableHandlerMethodArgumentResolver} and
...
class SpringDataAnnotationUtils {
    ...
    /**
     * Returns whether the given {@link Method} has more than one {@link org.springframework.data.domain.Pageable} parameter.
     *
